defmodule Membrane.RTP.AV1.ExWebRTC.OBU do
  @moduledoc false
  # Open Bitstream Unit parsing and serialization for AV1.
  # Adapted from ExWebRTC.RTP.AV1.OBU
  #
  ...
  # OBU type constants for external use
  def obu_type_sequence_header, do: @obu_sequence_header
  def obu_type_temporal_delimiter, do: @obu_temporal_delimiter
end
